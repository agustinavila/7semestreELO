...
%**************** Punto 1 *************************
%Funciones continuas
t=-6:0.01:10; %base temporal de se�ales continuas
x1t=6*sin(2*pi*t);
x2t=5*ustep(t-3);
x3t=4*tri((t+2)/4);
x4t=x1t+x2t+x3t;
...
%Operaciones B�sicas con Se�ales Discretas
%---------------------------------------------------------------
% Inicializaci�n
clear all;
close all;
% Adquisici�n de audio con Fs
...
N = length(x);
%---------------------------------------------------------------
% Generaci�n de eco mediante la suma de la versi�n retrasada de la se�al.
...
soundsc(z,Fs);
%---------------------------------------------------------------
% Submuestreo por 2 - Decimaci�n
%Procesamiento Digital de Se�ales Ciclo 2020 Laboratorio 1
z = zeros(1,N);
