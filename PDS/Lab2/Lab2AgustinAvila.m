...
%punto 3.5
s=load('ecg_data1.txt');
t=s(:,1);

signal1=s(:,3);
n1=10;
h1=(1/n1)*ones(1,n1);   %promediador de 10 muestras
y10=conv(signal1,h1,'same');

signal2=s(:,3);
n2=100;
h2=(1/n2)*ones(1,n2);   %promediador de 100 muestras
y100=conv(signal2,h2,'same');

%graficacion
limx=[50 100];  %esta variable define los limites para graficar
...
subplot(2,2,3); 
plot(t,y10);
title("señal 1 con promediador "+n1+" muestras")
xlim(limx);grid on;

subplot(2,2,4); 
plot(t,y100);
title("señal 1 con promediador de "+n2+" muestras")
xlim(limx);grid on;